            ...
            <div className="bankGrid">
              <section>
                ...
                <div className="bulkBox">
                  <div><strong>Adicionar várias de uma vez</strong><span>Digite ou cole uma mensagem por linha. Não existe limite de quantidade.</span></div>
                  ...
                  <button className="secondary" type="button" onClick={addMessages}>+ Adicionar ao banco</button>
                </div>
              </section>
